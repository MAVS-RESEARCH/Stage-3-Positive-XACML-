...
- previous WorkPlan blob hash: `<AUTHOR_GIT_OBJECT_004>`
- previous relevant spec blob hash (`IMPLEMENTATION_SPEC.md`): `<AUTHOR_GIT_OBJECT_001>`
- previous prereg seal blob hash (`prereg_sha256.txt`): `<AUTHOR_GIT_OBJECT_003>`
- resulting WorkPlan blob hash: `<AUTHOR_GIT_OBJECT_002>`
...
- repository commit before amendment: `<AUTHOR_REPO_COMMIT_011>`
